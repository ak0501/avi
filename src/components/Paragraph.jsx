...
const Paragraph = () => {
  return (
    <>
      <p>
        <strong>O</strong>riginally from Nepal, I came to the United States in pursuit of higher education. I received my degree in Manufacturing Engineering and have been working in the field of manufacturing for number of years. 
